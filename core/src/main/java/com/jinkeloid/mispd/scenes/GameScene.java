...
import com.jinkeloid.mispd.actors.mobs.DemonSpawner;
...
import com.jinkeloid.mispd.effects.CircleArc;
import com.jinkeloid.mispd.effects.EmoIcon;
import com.jinkeloid.mispd.effects.Flare;
import com.jinkeloid.mispd.effects.FloatingText;
import com.jinkeloid.mispd.effects.Ripple;
...
import com.jinkeloid.mispd.items.bags.MagicalHolster;
...
import com.jinkeloid.mispd.levels.RegularLevel;
import com.jinkeloid.mispd.levels.rooms.Room;
import com.jinkeloid.mispd.levels.rooms.secret.SecretRoom;
...
import com.jinkeloid.mispd.sprites.DiscardedItemSprite;
import com.jinkeloid.mispd.sprites.HeroSprite;
import com.jinkeloid.mispd.sprites.ItemSprite;
import com.jinkeloid.mispd.tiles.CustomTilemap;
import com.jinkeloid.mispd.tiles.DungeonTerrainTilemap;
import com.jinkeloid.mispd.tiles.DungeonTileSheet;
import com.jinkeloid.mispd.tiles.DungeonTilemap;
import com.jinkeloid.mispd.tiles.DungeonWallsTilemap;
import com.jinkeloid.mispd.tiles.FogOfWar;
import com.jinkeloid.mispd.tiles.GridTileMap;
import com.jinkeloid.mispd.tiles.RaisedTerrainTilemap;
import com.jinkeloid.mispd.tiles.TerrainFeaturesTilemap;
import com.jinkeloid.mispd.tiles.WallBlockingTilemap;
...
import com.jinkeloid.mispd.ui.TargetHealthIndicator;
import com.jinkeloid.mispd.ui.Toast;
...
import com.jinkeloid.mispd.windows.WndBag.Mode;
import com.jinkeloid.mispd.windows.WndGame;
import com.jinkeloid.mispd.windows.WndHero;
import com.jinkeloid.mispd.windows.WndInfoCell;
import com.jinkeloid.mispd.windows.WndInfoItem;
import com.jinkeloid.mispd.windows.WndInfoMob;
import com.jinkeloid.mispd.windows.WndInfoPlant;
import com.jinkeloid.mispd.windows.WndInfoTrap;
import com.jinkeloid.mispd.windows.WndMessage;
import com.jinkeloid.mispd.windows.WndOptions;
import com.jinkeloid.mispd.windows.WndStory;
...
//		Music.INSTANCE.play( Assets.Music.GAME, true );
		...
		super.create();
		Camera.main.zoom( GameMath.gate(minZoom, defaultZoom + MISPDSettings.zoom(), maxZoom));
		...
		if (InterlevelScene.mode != InterlevelScene.Mode.NONE) {
			...
			if (Dungeon.hero.hasPerk(Perk.ROGUES_FORESIGHT)
				...
				Random.pushGenerator(Dungeon.seedCurDepth());
					if (reqSecrets <= 0 && Random.Int(4) <= Dungeon.hero.pointsInTalent(Perk.ROGUES_FORESIGHT)){
...
//			for (int i = 1; i <= Dungeon.hero.perks.size(); i++){
...
//			}
	...
	public static void layoutTags() {
		...
		float tagLeft = MISPDSettings.flipTags() ? 0 : uiCamera.width - scene.attack.width();

		if (MISPDSettings.flipTags()) {
