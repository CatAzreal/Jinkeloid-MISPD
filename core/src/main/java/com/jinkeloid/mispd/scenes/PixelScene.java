...
public class PixelScene extends Scene {
	...
	public void create() {
		...
		defaultZoom = MISPDSettings.scale();
		...
		if (Messages.lang() == Languages.CHINESE
				//Doubt my work would be translated into other languages
				//|| Messages.lang() == Languages.KOREAN || Messages.lang() == Languages.JAPANESE
		){
			renderedTextPageSize *= 2;
		}
		Game.platform.setupFontGenerators(renderedTextPageSize, MISPDSettings.systemFont());
