...
import com.jinkeloid.mispd.actors.mobs.Spinner;
...
public class v0_9_X_Changes {
	...
	public static void add_v0_9_1_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton( new Image(Assets.Interfaces.TALENT_ICONS, 0, 0, 16, 16), Perk.HEARTY_MEAL.title(),
