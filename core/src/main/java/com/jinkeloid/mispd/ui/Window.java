...
import com.jinkeloid.mispd.effects.ShadowBox;
...
public class Window extends Group implements Signal.Listener<KeyEvent> {
	...
	public static final int MISPD_COLOR = 0x30B7FF;
	public static final int POSITIVE_COLOR = 0x0CC928;
	public static final int NEGATIVE_COLOR = 0xE0902D;
	public static final int WARNING_COLOR = 0xb50000;
	...
	public boolean onSignal( KeyEvent event ) {
		if (event.pressed) {
			if (KeyBindings.getActionForKey( event ) == MISPDAction.BACK){
				onBackPressed();
			}
		}
