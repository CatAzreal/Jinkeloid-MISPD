...
package com.jinkeloid.mispd.items.weapon;
...
import com.jinkeloid.mispd.items.weapon.curses.Annoying;
import com.jinkeloid.mispd.items.weapon.curses.Displacing;
import com.jinkeloid.mispd.items.weapon.curses.Exhausting;
import com.jinkeloid.mispd.items.weapon.curses.Fragile;
import com.jinkeloid.mispd.items.weapon.curses.Friendly;
import com.jinkeloid.mispd.items.weapon.curses.Polarized;
import com.jinkeloid.mispd.items.weapon.curses.Sacrificial;
import com.jinkeloid.mispd.items.weapon.curses.Wayward;
import com.jinkeloid.mispd.items.weapon.enchantments.Blazing;
import com.jinkeloid.mispd.items.weapon.enchantments.Blocking;
import com.jinkeloid.mispd.items.weapon.enchantments.Blooming;
import com.jinkeloid.mispd.items.weapon.enchantments.Chilling;
import com.jinkeloid.mispd.items.weapon.enchantments.Corrupting;
import com.jinkeloid.mispd.items.weapon.enchantments.Elastic;
import com.jinkeloid.mispd.items.weapon.enchantments.Grim;
import com.jinkeloid.mispd.items.weapon.enchantments.Kinetic;
import com.jinkeloid.mispd.items.weapon.enchantments.Lucky;
import com.jinkeloid.mispd.items.weapon.enchantments.Projecting;
import com.jinkeloid.mispd.items.weapon.enchantments.Shocking;
import com.jinkeloid.mispd.items.weapon.enchantments.Unstable;
import com.jinkeloid.mispd.items.weapon.enchantments.Vampiric;
...
abstract public class Weapon extends KindOfWeapon {
	...
	public int proc( Char attacker, Char defender, int damage ) {
		...
		if (!levelKnown && attacker == Dungeon.hero) {
			float uses = Math.min( availableUsesToID, Perk.itemIDSpeedFactor(Dungeon.hero, this) );
	...
	public void onHeroGainExp( float levelPercent, Hero hero ){
		levelPercent *= Perk.itemIDSpeedFactor(hero, this);
	...
	protected static int STRReq(int tier, int lvl){
		...
		if (Dungeon.hero.pointsInTalent(Perk.STRONGMAN) >= 2) req--;
