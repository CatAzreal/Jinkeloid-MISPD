...
import com.jinkeloid.mispd.items.armor.curses.AntiEntropy;
import com.jinkeloid.mispd.items.armor.curses.Bulk;
import com.jinkeloid.mispd.items.armor.curses.Corrosion;
import com.jinkeloid.mispd.items.armor.curses.Displacement;
import com.jinkeloid.mispd.items.armor.curses.Metabolism;
import com.jinkeloid.mispd.items.armor.curses.Multiplicity;
import com.jinkeloid.mispd.items.armor.curses.Overgrowth;
import com.jinkeloid.mispd.items.armor.curses.Stench;
import com.jinkeloid.mispd.items.armor.glyphs.Affection;
...
import com.jinkeloid.mispd.items.armor.glyphs.Entanglement;
import com.jinkeloid.mispd.items.armor.glyphs.Flow;
import com.jinkeloid.mispd.items.armor.glyphs.Obfuscation;
import com.jinkeloid.mispd.items.armor.glyphs.Potential;
import com.jinkeloid.mispd.items.armor.glyphs.Repulsion;
import com.jinkeloid.mispd.items.armor.glyphs.Stone;
		...
		if (action.equals(AC_DETACH) && seal != null){
			...
			if (detaching.getGlyph() != null){
				if (hero.hasTalent(Perk.RUNIC_TRANSFERENCE)
					...
					inscribe(null);
				} else if (hero.pointsInTalent(Perk.RUNIC_TRANSFERENCE) == 2){
					inscribe(null);
				} else {
