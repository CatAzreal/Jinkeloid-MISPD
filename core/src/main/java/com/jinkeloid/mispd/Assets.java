...
public class Assets {
	...
	public static class Interfaces {
		...
		public static final String ST_BAR	= "interfaces/st_bar.png";
	...
	public static class Music {
		...
		public static final String THEME	= "music/Peacock/WelkinWing_cut.mp3";

		public static final String SEWER		= "music/Peacock/Winterwind_cut.mp3";
		public static final String SEWERBOSS	= "music/Peacock/Starcrater_cut.mp3";
		public static final String PRISON		= "music/Peacock/Error_cut.mp3";
		public static final String PRISONBOSS	= "music/Peacock/ComboBreakerJapan_cut.mp3";
		public static final String CAVE			= "music/Peacock/GhostTrain_cut.mp3";
		public static final String CAVEBOSS		= "music/Peacock/FieldOfMemories_cut.mp3";
		public static final String CITY			= "music/Peacock/Homeland_cut.mp3";
		public static final String CITYBOSS		= "music/Peacock/FinalBattle_cut.mp3";
		public static final String HALL			= "music/Peacock/Conclusion_cut.mp3";
		public static final String HALLBOSS		= "music/Peacock/RicochetLove_cut.mp3";
	}
