...
package com.jinkeloid.mispd.services.news;
...
public class News {
	...
	public static void checkForNews(){
		...
		service.checkForArticles(!MISPDSettings.WiFi(), useHTTPS, new NewsService.NewsResultCallback() {
			@Override
	...
	public static Image parseArticleIcon(NewsArticle article){
		...
		//if we run into any formatting errors (or icon is null), default to the news icon
			...
			if (article.icon != null) MusicImplantSPD.reportException(e);
