...
import com.jinkeloid.mispd.actors.buffs.Adrenaline;
...
import com.jinkeloid.mispd.effects.Surprise;
import com.jinkeloid.mispd.effects.Wound;
...
import com.jinkeloid.mispd.items.weapon.missiles.darts.Dart;
...
public abstract class Mob extends Char {
	...
	public void add( Buff buff ) {
		MusicImplantSPD.actorLogger.logActorEntry(this.getClass(),"add", buff.getClass().getSimpleName());
		super.add( buff );
	...
	public void remove( Buff buff ) {
		MusicImplantSPD.actorLogger.logActorEntry(this.getClass(),"remove", buff.getClass().getSimpleName());
		super.remove( buff );
	...
	protected boolean canAttack( Char enemy ) {
		MusicImplantSPD.actorLogger.logActorEntry(this.getClass(),"canAttack", enemy.getClass().getSimpleName());
	...
	protected boolean getCloser( int target ) {
		MusicImplantSPD.actorLogger.logActorEntry(this.getClass(),"getCloser", target+"");
	...
	protected boolean getFurther( int target ) {
		MusicImplantSPD.actorLogger.logActorEntry(this.getClass(),"getFurther", target+"");
		if (rooted || target == pos) {
			return false;
		}
	...
	protected boolean doAttack( Char enemy ) {
		MusicImplantSPD.actorLogger.logActorEntry(this.getClass(),"doAttack", enemy.getClass().getSimpleName());
	...
	public void die( Object cause ) {
		...
		if (!(this instanceof Wraith)
				&& soulMarked
				&& Random.Int(10) < Dungeon.hero.pointsInTalent(Perk.NECROMANCERS_MINIONS)){
	...
	public void rollToDropLoot(){
		...
		//soul eater talent
		if (buff(SoulMark.class) != null &&
				Random.Int(10) < Dungeon.hero.pointsInTalent(Perk.SOUL_EATER)){
			Perk.onFoodEaten(Dungeon.hero, 0, null);
		}

		//bounty hunter talent
		if (Dungeon.hero.buff(Perk.BountyHunterTracker.class) != null){
			Dungeon.level.drop(new Gold(10 * Dungeon.hero.pointsInTalent(Perk.BOUNTY_HUNTER)), pos).sprite.drop();
		}
