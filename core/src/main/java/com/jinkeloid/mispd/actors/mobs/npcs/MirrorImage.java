...
import com.jinkeloid.mispd.sprites.MirrorSprite;
...
public class MirrorImage extends NPC {
	...
	public int damageRoll() {
		int damage;
		if (hero.belongings.mainhand != null){
			damage = hero.belongings.mainhand.damageRoll(this);
		} else {
	...
	protected boolean canAttack(Char enemy) {
		return super.canAttack(enemy) || (hero.belongings.mainhand != null && hero.belongings.mainhand.canReach(this, enemy.pos));
	}
	
	@Override
	public int drRoll() {
		if (hero != null && hero.belongings.mainhand != null){
			return Random.NormalIntRange(0, hero.belongings.mainhand.defenseFactor(this)/2);
		} else {
			return 0;
		}
	}
	...
	public int attackProc( Char enemy, int damage ) {
		...
		if (hero.belongings.mainhand != null){
			damage = hero.belongings.mainhand.proc( this, enemy, damage );
