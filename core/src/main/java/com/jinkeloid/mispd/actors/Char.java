...
import com.jinkeloid.mispd.actors.buffs.ArcaneArmor;
...
import com.jinkeloid.mispd.actors.buffs.FrostImbue;
...
import com.jinkeloid.mispd.actors.buffs.Speed;
import com.jinkeloid.mispd.actors.buffs.Stamina;
...
import com.jinkeloid.mispd.actors.mobs.Elemental;
...
import com.jinkeloid.mispd.items.scrolls.exotic.ScrollOfPsionicBlast;
...
import com.jinkeloid.mispd.items.weapon.missiles.darts.ShockingDart;
import com.jinkeloid.mispd.levels.Terrain;
import com.jinkeloid.mispd.levels.features.Chasm;
import com.jinkeloid.mispd.levels.features.Door;
	...
	public boolean canInteract(Char c){
		if (Dungeon.level.adjacent( pos, c.pos )){
			return true;
				...
				&& Dungeon.level.distance(pos, c.pos) <= 3*Dungeon.hero.pointsInTalent(Perk.ALLY_WARP)){
			return true;
		} else {
			return false;
		}
