...
public class Preparation extends Buff implements ActionIndicator.Action {
	...
	public enum AttackLevel{
		...
		public float KOThreshold(){
			return KOThresholds[ordinal()][Dungeon.hero.pointsInTalent(Perk.ENHANCED_LETHALITY)];
		}
		...
		public int blinkDistance(){
			return blinkRanges[ordinal()][Dungeon.hero.pointsInTalent(Perk.ASSASSINS_REACH)];
		}
