...
public class AndroidPlatformSupport extends PlatformSupport {
	...
	public void updateDisplaySize(){
		if (MISPDSettings.landscape() != null) {
			AndroidGame.instance.setRequestedOrientation( MISPDSettings.landscape() ?
		...
		if (fullscreen && MISPDSettings.landscape() != null
				&& (Game.dispWidth >= Game.dispHeight) != MISPDSettings.landscape()){
		...
		if (Game.dispWidth < renderWidth*2 || Game.dispHeight < renderHeight*2)
			MISPDSettings.put( MISPDSettings.KEY_POWER_SAVER, true );
		
		if (MISPDSettings.powerSaver() && fullscreen){
