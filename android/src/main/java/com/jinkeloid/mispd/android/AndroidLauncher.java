...
public class AndroidLauncher extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			text.setText("MISPD cannot start because some of its code is missing!\n\n" +
					"This usually happens when the Google Play version of the game is installed from somewhere outside of Google Play.\n\n" +
					"If you're unsure of how to fix this, please email the developer (jinkeloidovah@gmail.com), and include this error message:\n\n" +
					e.getMessage());
			text.setTextSize(16);
